...
export default function InsightCard({ insight, size = "default" }: Props) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col bg-white border border-gray-100 rounded-2xl overflow-hidden hover:border-gray-300 hover:shadow-lg transition-all duration-200"
    >
      {/* Thumbnail */}
      ...
      <div className="flex flex-col flex-1 p-5 gap-3">
        ...
        {/* Headline */}
        <p className={`font-bold leading-snug text-gray-900 group-hover:text-gray-600 transition-colors ${isLarge ? "text-2xl" : "text-xl"}`}>
          {headline}
        </p>
