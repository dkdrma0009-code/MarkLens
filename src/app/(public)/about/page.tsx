...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      {/* Hero */}
      <div className="mb-16">
        <p className="text-xs font-semibold text-gray-400 dark:text-gray-600 uppercase tracking-widest mb-4">About MarkLens</p>
        <h1 className="text-4xl font-bold tracking-tight leading-tight mb-6 text-gray-900 dark:text-gray-100">
          마케팅 트렌드를 읽고,<br />실무를 준비하다.
        </h1>
        <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed">
          MarkLens는 글로벌 마케팅 아티클을 AI로 분석해 실무에 바로 쓸 수 있는 인사이트로 전달합니다.
          단순한 요약이 아니라, <em className="not-italic font-semibold text-gray-700 dark:text-gray-300">왜 중요한지 · 어떻게 적용할지 · 포트폴리오에 어떻게 녹여낼지</em>를 함께 고민합니다.
        </p>
      </div>
      ...
      <section className="mb-16">
        <h2 className="text-xl font-bold mb-5 text-gray-900 dark:text-gray-100">왜 만들었나요</h2>
        <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-[1.9]">
          <p>
      ...
      {/* Who */}
      <section className="mb-16">
        <h2 className="text-xl font-bold mb-5 text-gray-900 dark:text-gray-100">누구를 위한 뉴스레터인가요</h2>
      ...
      {/* How it works */}
      <section className="mb-16">
        <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-gray-100">어떻게 만들어지나요</h2>
          ...
          {[
            ...
            <div key={item.step} className="flex gap-4">
              <div className="flex flex-col items-center">
                ...
                {i < 3 && <div className="w-px flex-1 bg-gray-200 dark:bg-gray-800 mt-2" />}
              </div>
              <div className="pb-5">
                <p className="font-semibold text-gray-900 dark:text-gray-100 mb-1">{item.title}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">{item.desc}</p>
      ...
      {/* Newsletter sections */}
      <section className="mb-16">
        <h2 className="text-xl font-bold mb-5 text-gray-900 dark:text-gray-100">뉴스레터 5가지 섹션</h2>
        <div className="divide-y divide-gray-100 dark:divide-gray-800">
          {[
            ...
            <div key={item.num} className="flex gap-4 py-4">
      ...
      <div className="rounded-2xl bg-black dark:bg-white p-8 text-center">
        ...
        <h2 className="text-2xl font-bold text-white dark:text-black mb-3">
          매주 월요일, 한 주를 시작하는<br />마케팅 브리핑
        </h2>
        <p className="text-white/60 dark:text-black/50 text-sm mb-6">
          무료 구독 · 언제든 취소 가능
        </p>
        <Link
          href="/newsletter"
