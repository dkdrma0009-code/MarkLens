...
보정 예시 (이 기준으로 점수를 매겨라 — 좋은 꺾기를 과소평가하지 말 것):
- [pivot 2, cliche 4] 인사이트 "MZ는 합리적 소비를 한다" + 기회 "중고 할인 행사 확대" → 문제를 '가격'으로만 푼 1차원. 누구나 떠올림.
- [pivot 4, cliche 2] 인사이트 "중고는 절약이 아니라 안목의 증명" + 기회 "제품마다 이전 소유자의 스토리를 자산화한 '유일성' 커머스" → 가격 경쟁의 판을 '서사·유일성'으로 옮김. 이 수준이면 분명히 꺾인 것이니 pivot 4 이상으로 인정한다.
- 핵심: 사용자가 '문제를 푸는 방식'이 아니라 '경쟁의 판/맥락'을 바꿨다면 직선이 아니다. 단지 표현이 평범하다고 직선으로 깎지 말 것.
